...
class ReviewModelTest(unittest.TestCase):
    def setUp(self):
        ...
        self.new_review = Review(pitch_id=12345,pitch_title='Review for pitches',review='This pitch is the best thing since good weed',user = self.user_James)
    ...
    def test_check_instance_variables(self):
        ...
        self.assertEquals(self.new_review.pitch_review,'This pitch is the best thing since good weed')
